 ...
 */
public final class AgeDependentInfectionModelWithoutSeasonality implements InfectionModel {

	private final FaceMaskModel maskModel;
	private final EpisimConfigGroup episimConfig;

	@Inject AgeDependentInfectionModelWithoutSeasonality(FaceMaskModel faceMaskModel, Config config) {
